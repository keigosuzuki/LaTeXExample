...
\section{\TeX}
\TeX (読み方は，テフ，テックなど)という文章組版システムを用いて論文・資料作成を行います。
...
\LaTeX 環境を構築するには TeX Live をインストールするのが標準的です。

\subsection{TeX Live}
\url{https://www.tug.org/texlive/}

Windows, macOS (MacTeX), Linux のいずれの環境でも TeX Live を用いることで同一のコンパイル環境を構築できます。
